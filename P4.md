...
```
    ...
    Duración de la simulación:  7.290125608444214
    2519 errores, para un BER de 0.0060.
    




    <matplotlib.image.AxesImage at 0x2758711bfd0>
...
```
    ...
    Duración de la simulación:  11.35825514793396
    6814 errores, para un BER de 0.0161.
